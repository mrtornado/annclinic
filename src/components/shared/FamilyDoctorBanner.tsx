...
export default function FamilyDoctorBanner() {
  ...
  return (
    <div
      className={`fixed bottom-3 right-3 sm:bottom-6 sm:right-6 z-50 transform transition-all duration-1000 ease-out ${
        isAnimating
    ...
    >
      {/* Floating Banner */}
      <div className="relative bg-gradient-to-br from-teal-600 via-teal-700 to-slate-800 text-white rounded-2xl sm:rounded-3xl shadow-2xl p-3 sm:p-6 max-w-[280px] sm:max-w-sm overflow-hidden hover:scale-105 transition-all duration-300 hover:shadow-teal-500/30 animate-pulse-slow">
        {/* Background effects */}
        ...
        <button
          ...
          className="hidden sm:flex absolute top-3 right-3 w-8 h-8 bg-white/30 backdrop-blur-sm rounded-full items-center justify-center text-white hover:text-white hover:bg-white/40 transition-all duration-200 text-base font-bold z-20"
        ...
        <div className="relative z-10">
          ...
          <div className="sm:hidden">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-8 h-8 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm flex-shrink-0">
              ...
              <button
                onClick={() => setIsVisible(false)}
                className="w-6 h-6 bg-white/30 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:bg-white/40 transition-all duration-200 text-sm font-bold flex-shrink-0"
                aria-label="Închide banner"
              >
                ×
              </button>
            ...
            <a
              href="/programare"
              className="block w-full bg-gradient-to-r from-white to-cyan-50 text-teal-700 font-bold py-2 px-3 rounded-xl text-center hover:from-cyan-50 hover:to-white transition-all duration-300 shadow-lg text-sm"
            >
